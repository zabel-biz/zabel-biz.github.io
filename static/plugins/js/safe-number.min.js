...
(function(){function b(a){var c=a.split("").reverse();a="";c=$jscomp.makeIterator(c);for(var e=c.next();!e.done;e=c.next()){e=e.value;var h=Math.random().toString(36).substring(7);a+='<em style="display:none;">'+h+"</em>";a+="<span>"+e+"</span>"}return a}function d(a){a.style.direction="rtl";a.style["unicode-bidi"]="bidi-override"}function k(a){d(a);a.innerHTML.trim()||(a.innerHTML=b(atob(a.dataset[f.number])));a.addEventListener("click",function(c){var e=atob("dGVsOgo=")+atob(a.dataset[f.number]
);c.preventDefault();window.location.href=e})}var f={number:"number_b64"};window.areNumbersInitialized||(window.areNumbersInitialized=!0,document.addEventListener("DOMContentLoaded",function(){var a=document.querySelectorAll("[data-"+f.number+"]");a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next())k(c.value)}))})();
